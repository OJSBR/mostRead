...
/**
 * @file plugins/blocks/mostRead/tests/PluginTest.php
 *
...
class PluginTest extends TestCase
{
    ...
    {
        return [
            \APP\plugins\blocks\mostRead\MostReadBlockPlugin::class,
            \APP\plugins\blocks\mostRead\MostReadSettingsForm::class,
        ];
    }
