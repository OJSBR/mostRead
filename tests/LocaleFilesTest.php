...
/**
 * @file plugins/blocks/mostRead/tests/LocaleFilesTest.php
 *
...
class LocaleFilesTest extends TestCase
{
    ...
    public const REVIEWED = ['en', 'pt_PT', 'pt_BR', 'es', 'ca', 'gl', 'fr_FR', 'fr_CA', 'it', 'de', 'nl', 'fi', 'pl'];
    ...
    public function testEveryKeyTheCodeUsesExists(): void
    {
        ...
        preg_match_all('/plugins\.blocks\.mostRead\.[a-zA-Z0-9_.]*[a-zA-Z0-9_]/', $sources, $m);
